...
@section('content')
<div x-data="suppliersPage()" x-init="load()" class="page-list">
    <div class="flex items-center justify-end mb-4">
        <a href="/suppliers/create" class="btn-primary"><svg class="w-4 h-4 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg> Add Supplier</a>
    </div>
    <div class="card">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <template x-if="loading">
                            <tr><td colspan="7" class="p-0"><template x-for="i in 10" :key="'sk'+i"><div class="skeleton-row"><div class="skeleton h-3 w-16"></div><div class="skeleton h-3 w-28"></div><div class="skeleton h-3 w-28"></div><div class="skeleton h-3 w-24"></div><div class="skeleton h-3 w-32"></div><div class="skeleton h-3 w-24"></div><div class="skeleton h-3 w-16"></div></div></template></td></tr>
                        </template>
                    </tbody>
                </table>
            </div>
