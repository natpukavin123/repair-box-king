...
table.inv-tbl thead th{background:#111;color:#fff;font-size:6.5px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;padding:4.5px 6px;text-align:center;border-right:1px solid #2d2d2d;}
...
table.inv-tbl tfoot td{background:#111;color:#fff;font-size:8px;font-weight:700;padding:5px 6px;text-align:right;border-right:1px solid #2d2d2d;}
...
table.sum-tbl .row-grand td{background:#111;color:#fff;font-family:'Playfair Display',Georgia,serif;font-size:10.5px;font-weight:700;padding:6px 9px;border-bottom:none;}
...
<div class="a4-shell">
    <!-- LEFT HALF: INVOICE (148.5mm × 210mm) -->
    <div class="inv-half">
        <div class="inv">
                ...
                <table class="inv-tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tr" style="color:#6b7280;@if($item['mrp'] > $item['rate']) text-decoration:line-through; @endif">@if($item['mrp'] > $item['rate']){{ number_format($item['mrp'],2) }}@else&mdash;@endif</td>
