                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <template x-if="loading">
                            <tr><td colspan="6" class="p-0"><template x-for="i in 10" :key="'sk'+i"><div class="skeleton-row"><div class="skeleton h-3 w-16"></div><div class="skeleton h-3 w-16 rounded-full"></div><div class="skeleton h-3 w-32"></div><div class="skeleton h-3 w-20"></div><div class="skeleton h-3 w-20"></div><div class="skeleton h-3 w-20"></div></div></template></td></tr>
                        </template>
                    </tbody>
                </table>
            </div>
