...
<div x-data="rechargesPage()" x-init="init()" class="workspace-screen rch-workspace w-full lg:overflow-hidden">
    <div class="grid w-full lg:flex-1 lg:min-h-0 grid-cols-1 gap-2 lg:overflow-hidden lg:grid-cols-3 lg:grid-rows-1">
        ...
        <div class="flex lg:min-h-0 flex-col lg:overflow-hidden lg:col-span-2">
            ...
            {{-- Filter bar --}}
            <div class="rch-filterbar mb-1 flex shrink-0 flex-wrap items-center gap-1.5">
                {{-- Status dropdown --}}
